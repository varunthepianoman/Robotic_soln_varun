...
public:
    SensorClient(std::string name, int num_samples)
        ...
        , num_samples{num_samples}
        {
            ...
            rclcpp::Client<custom_interfaces::srv::SensorRead>::SharedPtr client = this->create_client<custom_interfaces::srv::SensorRead>("sensor1_read_service", rclcpp::QoS::rmw_qos_profile_default, callback_group);
        }
